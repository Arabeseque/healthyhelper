  ...
  <view class="calender-container">
    <view class="calender-content">
      ...
      <view class="calender-title" v-if="isWeek">
        ...
        <view
          class="calender-title-morebtn"
          v-if="isMorebtn"
          @click="toggleMove">
          更多
        </view>
        <view
          class="calender-title-right"
          @click="popupShowBtn"
          v-if="ispopupShow">
          ？
        </view>
      ...
      <view class="calender-title" v-if="!isWeek">
        ...
        <view class="calender-title-chevronr calender-title-chevronr-right">
          <text
            class="iconfont icon-right text-[28rpx]"
            @click="changeMonth(1)"></text>
        </view>
      </view>
      <!-- 星期头部 -->
      <view class="calender-week-head">
        <view
          class="calender-week-head-item"
      ...
      <transition name="fade">
        <view
          class="calender-month-container"
          ...
          <view
            ...
            :key="index"
            class="calender-month-item">
            <view
              v-for="(week, weekindex) in month"
              :key="weekindex"
              class="calender-month-week">
              <!--   :class="{ ischecked: checkedDay == day.date, istoday: day.istoday }" -->
              <view
                v-for="(day, dayindex) in week"
                :class="{ ischecked: checkedDay == day.date }"
                @click.stop="chooseDay(day)"
                :key="dayindex"
                class="calender-month-week-item">
                <view
                  class="calender-week-day"
                  :class="{
